$(function() {
	...
	var nmb_images_wrapper  = 9;
	var nmb_images = $('#msg_thumbs img').length;
	...
	function showControls(){
	    $('#msg_controls')
		    .stop()
		    .animate({'right':'15px'},500);
	}
	function hideControls(){
	    $('#msg_controls')
		    .stop()
		    .animate({'right':'-110px'},500);
	}
	...
	function alternateThumbs(){
	    $('#msg_thumbs')
		    .find('.msg_thumb_wrapper:nth-child('+current_thumb+')')
		    .hide();
	...
	function next_thumb(){
	    var $next_wrapper = 
		    $('#msg_thumbs')
		    .find('.msg_thumb_wrapper:nth-child('+parseInt(current_thumb+1)+')');
	 ...
	 */
	$('#msg_thumbs .msg_thumb_wrapper > a')
	    .bind('click',
		      function(e){
		          var $this = $(this);
	...
	/**
	 * resize the image to fit in the container (600 x 600)
	 */
